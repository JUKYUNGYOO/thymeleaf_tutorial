package com.example.thymeleaf_t.controller;

import com.example.thymeleaf_t.model.User;
...
public class UserController {
    ...
    // http://localhost:8083/selection-expression
...
//    handler method to handle fragment expression
    ...
    public String users(Model model){
        User admin = new User("Admin","admin@gmail.com",
                "ADMIN", "Male");
        User ramesh = new User("Ramesh","ramesh@gmail.com",
                "USER", "Male");
        User meena = new User("Meena", "meena@gmail.com",
                "USER", "FEMALE");
